...
/**
 * 文件名称: ConfigurableAgentCard.java
 * 模块: web
 * 包: io.agentscope.runtime.protocol.a2a
 *
 * ConfigurableAgentCard，配置类。
 */
 ...
 *
 * <p>
 *     These attributes are used to generate agent card which export by well-known URL.
 * </p>
 *
 * @author xiweng.yy
 */
public class ConfigurableAgentCard {
    ...
    public ConfigurableAgentCard(String name, String description, String url, AgentProvider provider, String version,
    ...
    public static class Builder {
        ...
        public ConfigurableAgentCard build() {
            return new ConfigurableAgentCard(name, description, url, provider, version, documentationUrl, defaultInputModes,
